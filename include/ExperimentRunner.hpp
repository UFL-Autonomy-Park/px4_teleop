#ifndef EXPERIMENTRUNNER_HPP_
#define EXPERIMENTRUNNER_HPP_
...
class ExperimentRunner {
 ...
 private:
  ...
  virtual void controlLoop (const geometry_msgs::msg::PoseStamped agent_pose_stamped,
